...
export const State = () => {
  ...
  return (
    <div className="flex  flex-wrap  lg:flex-row gap-3 mt-10 items-center">
      <Card className="w-64 h-40 lg:scale-80  2xl:scale-100 mx-auto   p-6  flex flex-col justify-center  border-zinc-800 dark:border-zinc-200 bg-transparent backdrop-blur-sm">
