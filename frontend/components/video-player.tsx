...
export default function VideoPlayer() {
  ...
  return (
    <div className="mt-40 w-[80%] relative lg:w-4xl lg:h-[500px] h-[300px] rounded-lg bg-gradient-to-b from-[#141516] to-[#08090A] flex items-center justify-center flex-col border border-white/10 gap-6 text-white">
      {/* Custom dropdown */}
      ...
      <div className=" absolute right-0 -top-10">
        ...
        {showShareMenu && (
          <div className="absolute right-0 mt-2 w-48 bg-[#1b1b1d] border border-white/10 rounded-lg shadow-lg overflow-hidden">
            <button
              onClick={() => handleShare("twitter")}
              className="w-full flex items-center gap-3 px-4 py-3 hover:bg-[#2a2a2c] transition text-white text-sm"
            >
            ...
            <button
              onClick={copyLink}
              className="w-full flex items-center gap-3 px-4 py-3 hover:bg-[#2a2a2c] transition text-white text-sm border-t border-white/10"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
