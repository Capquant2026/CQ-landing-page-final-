...
export default function Dashboard() {
  ...
  return (
    <div className="w-[1920px] bg-[#08090A] flex border border-[#1A1C1F]  h-[1080px] scale-75">
      <div className="w-64 bg-[#08090A] border-r border-[#1A1C1F] p-4  h-full flex flex-col items-start justify-between text-white">
        <div className="w-full">
          ...
          <div>
            <span className="mb-3 inline-block text-sm  opacity-50">Menu</span>
                ...
                if (item.label === "Dashboard") {
                  return (
                    <Button
                      key={index}
                      variant={"ghost"}
                      className="w-full py-2 bg-gradient-to-r from-[#141516]  hover:bg-[#151515] hover:text-white   cursor-pointer flex items-start justify-start "
                    >
                      <Icon
                        className={`mr-2`}
                        style={{
