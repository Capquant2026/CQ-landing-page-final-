...
export default function Dashboard() {
  ...
  return (
    <div className="relative  mt-20">
      <div className="absolute  w-full h-full left-0 top-0  bg-gradient-to-t pointer-events-none from-[#08090A] to-transparent   z-50" ></div>
      <motion.div className="w-[1600px] mt-20 containerdiv relative bg-[#08090A] flex border border-[#1A1C1F]  h-[900px] ">
        <div className="absolute h-full  right-0 w-full top-0 bg-gradient-to-l pointer-events-none from-[#08090A] to-transparent  z-20" />
        <div className="absolute  w-full  left-0 top-0 bg-gradient-to-t from-[#08090A] to-transparent  z-20" />
          ...
          <div className="w-full">
            <div className="flex   justify-between b w-full">
              <div className="flex items-center">
                <Image src={logo} alt="" />
                <h2 className="text-2xl">CapQuand</h2>
              </div>
              <button
                  ...
                  if (item.label === "Dashboard") {
                    return (
                      <Button
                        key={index}
                        variant={"ghost"}
                        className="w-full py-2 bg-gradient-to-r from-[#141516] hover:scale-110  hover:bg-[#151515] hover:text-white   cursor-pointer flex items-start justify-start "
                      >
                        <Icon
                          className={`mr-2`}
                          style={{
          ...
          <div className="w-full">
            ...
            <div className="">
              ...
              <div className="mt-2 bg-gradient-to-r border border-[#1A1C1F] from-[#141516]  rounded-xl">
                <Button
                  variant={"ghost"}
                  className="w-full flex items-center justify-between py-2 hover:bg-transparent hover:text-white cursor-pointer  "
                >
                  Intraday
                </Button>
                <Button
                  variant={"ghost"}
                  className="w-full flex items-center justify-between py-2   hover:text-white hover:bg-transparent cursor-pointer  "
                >
                  Swing
                </Button>
              </div>
              <Button
                variant={"ghost"}
                className="w-full bg-[#333638] mt-3 flex items-center justify-start py-2 hover:bg-[#151515] border border-[#1A1C1F] hover:text-white cursor-pointer  "
              >
                Deploy
              </Button>
            </div>
        ...
        <div className="text-white flex-1 h-screen p-4 ">
          <div className="text-white h-full bg-gradient-to-b px-10 py-4 rounded-xl from-[#141516] to-[#08090A]">
            ...
            <div className=" flex items-center mt-5 justify-center mx-auto w-1/2">
              <p className="opacity-50 mr-2">Next Round</p>
              <Button
                variant={"ghost"}
                className=" py-2 bg-gradient-to-r w-1/5 from-[#141516] border border-[#1A1C1F]  hover:bg-[#151515] hover:text-white   cursor-pointer flex items-center justify-center "
              >
